  ...
  return (
    <div className="bg-[#F6F6F6]">
      ...
      <div className="container-site pt-8">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-medium text-[#839678] hover:text-[#6b7d63] transition-colors"
        >
          <ArrowLeft size={15} />
          Retour à l&apos;accueil
        </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h2 className="font-[family-name:var(--font-source-serif)] text-2xl text-[#1c1c1c] font-light">
            ...
            <div className="flex flex-col gap-3">
              {IMPACTS.map((item) => (
                <div key={item.amount} className="flex items-center gap-4 bg-white rounded-[10px] p-5 shadow-sm">
            ...
            <div className="bg-white rounded-[10px] p-6 shadow-sm flex flex-col gap-4">
          ...
          {/* ── Droite : CTA ── */}
          <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col gap-7 lg:sticky lg:top-28">

            <div className="text-center flex flex-col gap-1">
              <h3 className="font-[family-name:var(--font-source-serif)] text-xl text-[#1c1c1c] font-light">
                Choisissez votre montant
              </h3>
              <p className="text-xs text-[#8a8a8a]">Vous serez redirigé vers PayPal, 100% sécurisé.</p>
            </div>
