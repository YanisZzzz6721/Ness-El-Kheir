      ...
      <div className="container-site relative z-10 text-center flex flex-col items-center gap-8">
        ...
        <div className="max-w-2xl flex flex-col gap-4">
          <h2 className="text-white font-[family-name:var(--font-source-serif)] font-light">
            Nous sommes toutes bénévoles.<br />Vous voulez nous aider ?
          </h2>
          <p className="text-white/60 leading-relaxed">
            Chaque don, petit ou grand, nous permet de continuer nos actions sur le terrain.
            Votre soutien fait une vraie différence dans la vie des personnes que nous aidons.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {["5 €", "10 €", "20 €", "50 €", "Autre montant"].map((m) => (
            <Link
              key={m}
              href="/faire-un-don"
              className="px-5 py-2.5 rounded-full border border-[#839678]/40 text-[#a3b396] text-sm font-semibold hover:bg-[#839678] hover:text-white hover:border-[#839678] transition-all duration-200"
            >
              {m}
            </Link>
          ))}
        ...
        <Link
          href="/faire-un-don"
          className="inline-flex items-center gap-2 bg-[#839678] text-white font-semibold px-9 py-4 rounded-full hover:bg-[#6b7d63] transition-all duration-200 hover:-translate-y-px hover:shadow-lg text-base"
        >
